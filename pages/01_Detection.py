...
with st.sidebar:
    ...
    # Reset crop state when switching cropping options
...
with col1:
    ...
    if uploaded_file is not None:
        ...
        # ============================================================
            ...
            st.info(
                f"✨ Auto center crop applied "
                f"(zoom: {zoom_factor*100:.0f}%)"
            )
        ...
        # ============================================================
        # PREDICT BUTTON - FULL FEATURE
        # ============================================================

        if st.button(
            get_text('detect_button', language),
            type="primary",
            ...
            with st.spinner(get_text('loading', language)):
                ...
                try:
                    ...
                    if crop_option == "Manual (draw rectangle)":
                        ...
                        if st.session_state.get('crop_applied', False):
                    ...
                    with col2:
                        ...
                        prob_df = pd.DataFrame({
                            ...
                            'Probability': [v * 100 for v in all_probs.values()]
                        ...
                        fig_bar = px.bar(prob_df, x='Probability', y='Display Name', orientation='h',
                        ...
                        if st.session_state.show_correction_form:
                            ...
                            correct_disease = st.selectbox(
                                "Select correct disease:",
                                disease_options,
                                format_func=lambda x: DISEASE_INFO.get(x, {}).get('name', x),
                                key="correct_disease"
                            )

                            comment = st.text_area(
                                "Additional comments (optional):",
                                placeholder="e.g., This leaf actually has...",
